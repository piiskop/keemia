...
Koguse kontsentratsioon on esitatud avaldisena \@ref(eq:amount-concentration) leheküljel `r render_pageref(reference="eq:amount-concentration")`)[@haynes_2014_crc, lk 2-8].
...
Vees lahustustuvus on esitatud tabelis \@ref(tab:solubility) leheküljel `r render_pageref(reference="tab:solubility")`.

(ref:solubility) Kilogrammi ühendi lahustuvus vees kilogrammi vee kohta[@haynes_2014_crc, lk 4-43-4-114]. Kui skalaarne lahustuvus ei ole teada, siis on lahustuvus märgitud järgnevalt: kergelt lahustuv: \qty{1}{\kg\per\kg}, lahustuv: \qty{1e-1}{\kg\per\kg}, väga lahustuv: \qty{1e-2}{\kg\per\kg}.
...
print_table(table=solubility, caption="(ref:solubility)", additional_header=c("Anioon"=1, "Muldmetallid"=5, "Leelismuldmetallid"=3, "Siirdemetallid"=3, "Järgne"=1, "Ammoonium"=1)) %>%
  landscape()
